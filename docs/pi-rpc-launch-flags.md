...
For the canonical explanation of how these launches resolve into final Pi system prompts,
see [Agent Deck system prompt logic](https://github.com/a-streetcoder/agent-deck/blob/main/agent-deck-documentation/agent-deck-system-prompt-logic.md).
