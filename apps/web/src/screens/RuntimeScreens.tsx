  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
          ...
          return (
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="truncate font-mono text-code text-text-primary">{entry.key}</div>
                <div
        ...
        {entries.length === 0 ? <AppEmptyState heading="No environment variables found." /> : null}
      </div>
    </PageShell>
  );
}
...
function CopyFixButton({ command }: { command: string }) {
  ...
  return (
    <Button
      ...
      variant="ghost"
      title={`Copy: ${command}`}
      leadingIcon={copied ? <Check size={11} /> : <Copy size={11} />}
      onClick={copy}
    >
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-wrap items-baseline gap-x-2">
                    ...
                    <span className="text-micro font-medium text-text-secondary">{label}</span>
                  </div>
