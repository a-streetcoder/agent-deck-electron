    ...
    >
      {activeRun ? (
        ...
        >
          ...
          {activeRun.checkpointPrompt &&
          (activeRun.stopReason === "humanApproved" || activeRun.stopReason === "humanRejected") ? (
            <div
          ...
          !activeRun.launch.checkoutAcknowledgedAt ? (
            ...
            >
              ...
              <Button
                ...
                leadingIcon={<ShieldCheck size={11} aria-hidden />}
          ...
          {activeRun.artifactDirectory ? (
            <div className="mt-2 space-y-1 text-detail" data-testid="loop-artifact-actions">
              ...
              {artifactActionMessage ? (
                <div role="status" className="break-all" data-testid="loop-artifact-action-status">
                  {artifactActionMessage}
                </div>
              ) : null}
            </div>
                  ...
                  {iteration.changedFiles?.length ? (
                    <ul aria-label={`Changed files for iteration ${iteration.index}`}>
                      {iteration.changedFiles.map((change, index) => (
                        <li key={`${change.status}-${change.path}-${index}`} className="break-all">
        ...
        {loops.map((loop, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="truncate text-label font-medium text-text-primary">{loop.name}</div>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-end gap-2 pt-1">
              <Button data-testid="loop-cancel" size="md" variant="secondary" onClick={closeEditor}>
                Cancel
              </Button>
              <Button
                size="md"
