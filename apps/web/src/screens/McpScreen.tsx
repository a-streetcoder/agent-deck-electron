          ...
          <div className={cn("flex flex-col gap-2", pasting && "hidden")}>
            {transport === "stdio" ? (
              <>
                ...
                <label className="flex min-w-0 flex-col gap-1">
                  <span className="text-caption font-medium text-text-secondary">Arguments</span>
                  <ControlInput
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="break-words text-detail text-danger">
                  Default assignment is missing a configured definition and grants no tools. Add the
                  definition or remove this All Projects assignment.
                </div>
              </div>
            </div>
          ))}
