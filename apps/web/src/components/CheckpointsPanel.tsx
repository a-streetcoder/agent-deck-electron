  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden" data-testid="checkpoints-panel">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-2 py-2" data-testid="checkpoints-list">
        {ordered.length === 0 ? (
          <p
            className="px-2 py-6 text-center text-detail text-text-muted"
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0 flex-1">
          <p className="truncate text-detail font-medium text-text-primary" title={label}>
            {label}
          </p>
    ...
    >
      ...
      >
        <div className="mb-2 flex items-center gap-2">
          ...
          <h2 className="text-label font-semibold text-text-primary">Roll back the session?</h2>
        </div>
        <p className="text-caption leading-[18px] text-text-muted">Restore the session to:</p>
        <p
          className="truncate text-detail font-medium leading-[18px] text-text-primary"
          title={label}
        >
          “{label}”
        </p>
        <p className="mt-1.5 text-caption leading-[18px] text-text-muted">
          This{" "}
        ...
        <div className="mt-auto flex justify-end gap-2">
          <ControlButton
            type="button"
            className="rounded-md px-3 py-1.5 text-detail font-medium text-text-muted transition-colors hover:bg-hover hover:text-text-primary disabled:opacity-50"
          ...
          <ControlButton
            type="button"
            className="rounded-md px-3 py-1.5 text-detail font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-50"
      ...
      {rerun ? (
        <p
          className="absolute left-1/2 top-[calc(50%+106px)] w-full max-w-[280px] -translate-x-1/2 text-center text-detail text-text-muted"
